...
M.style = function()
  ...
  highlight(0, "Type", { fg = white, italic = true })
  ...
  highlight(0, "Operator", { fg = "#80DBFF" })
  ...
  -- highlight(0, "Delimiter", { fg = "#FFD714" })
  ...
  highlight(0, "@constructor", { fg = violet })
